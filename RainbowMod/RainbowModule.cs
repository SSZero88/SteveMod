...
namespace Celeste.Mod.Rainbow {
    public class RainbowModule : EverestModule {
        ...
        public override void Load() {
            ...
            On.Celeste.Player.DashEnd += DieOnDash;
        }

        private void DieOnDash(On.Celeste.Player.orig_DashEnd orig, Player self)
        {
            if (Settings.DeathOnDashEnabled)
            {
                self.Die(self.Speed, true, true);
            }
        }
